...
if(isset($_POST['MM_insert'])){
	$maybes=array('company', 'address2', 'fax');
	$sql="INSERT INTO customers (fname, lname, email, address1, city, stateID, zipcode, phone {$maybes['include']})
	 VALUES ('{$_POST['fname']}', '{$_POST['lname']}', '{$_POST['email']}', '{$_POST['address1']}', '{$_POST['city']}', {$_POST['stateID']}, 
	 '{$_POST['zipcode']}', '{$_POST['phone']}' {$maybes['values']})";
	 if(mysql_query($sql)){
