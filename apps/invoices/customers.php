  ...
  <div id="page">
    ...
    <div id="content">
      <table border="1" align="center">
        ...
        <?php do { ?>
           <?php $full[]=$row_rs_customers; ?>
          <tr>
            <td align="center"><input type="checkbox" name="email[<?= $row_rs_customers['ID']; ?>" id="email[<?= $row_rs_customers['ID']; ?>]" value="1" /></td>
            <td><a href="customer_details.php?id=<?php echo $row_rs_customers['ID']; ?>"><?php echo $row_rs_customers['fname']; ?>&nbsp; <?php echo $row_rs_customers['lname']; ?></a>
            </td>
            <td><?php echo $row_rs_customers['company']; ?></td>
...
<?php echo "<pre>".print_r($full, true). "</pre>"; ?>
</body>
</html>
<?php
